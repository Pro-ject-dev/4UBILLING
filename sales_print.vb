...
Public Class sales_print
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Dim estatus = sendmail("Sales Report", "4U Fashions Sales Report", filePath)
            If estatus Then
                MessageBox.Show("Sales Report is successfully sended via Email!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
