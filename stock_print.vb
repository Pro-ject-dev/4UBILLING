...
Public Class stock_print
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Dim estatus = sendmail("Stocks Report", "4U Fashions Stocks Report", "C:\stock_report\report.pdf")
            If estatus Then
                MessageBox.Show("Stock Report is successfully sended via Email!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
        Catch ex As Exception
            MessageBox.Show("An error occurred: " & ex.Message)
        End Try
